...
| Theme               | Overrides the configured default theme to either light or dark mode.             |
...
| RSS feed       | An RSS feed of the 10 most recent posts is available at `/rss/latest.xml`.                             |
